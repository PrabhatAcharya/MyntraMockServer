function navbar() {
  ...
  <div id="other_div">
		  ...
		  <div id="pkr7">
			<div id="b">
			   <div class="div" id="d1">
				   ...
				   <button id="ls"><a id="logincss"href="../pages/loginSignup.html">${
	  ...
	  <div>
		  <a href="/pages/wishlist.html"><i class="fa-solid fa-heart font"  id="i1"><span id="count_wish">&nbsp;<span></i></a><br>
		<a id="wishlist_tag" href="/pages/wishlist.html">Whishlist</a>
	  </div>
  
	  <div>
		<a id="count" href="/pages/bag.html">  <i class="fa-solid fa-bag-shopping font " id="i1"><span  id="count_cart">&nbsp;</span></i></a>
		 <br>  <a id="cart_tag" href="/pages/bag.html">Bag</a>
	  </div>
  </div>
